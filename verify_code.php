...
$success = $_SESSION['success'] ?? ''; // Retrieve success message if set
unset($_SESSION['error']);  // Clear the error after displaying
unset($_SESSION['success']);  // Clear success after displaying

// Check if the verification code has expired
$isExpired = false;
if (isset($_SESSION['verification_expired']) && $_SESSION['verification_expired'] === true) {
    $isExpired = true;
    unset($_SESSION['verification_expired']);  // Reset the session flag after showing
}
?>
...
<body>
    <div class="login-container">
        <h2><span>Verify</span> <span>your account</span></h2>
        <p>Please check the verification code sent to your email.</p>

        <form action="../server/check_verification.php" method="POST">
            <label>Enter Verification Code</label>
            <input type="text" name="code" required>

            <?php if ($error): ?>
                <div class="error-message-container">
                    <p style="color: red; font-size: .7em; text-align: left;"><?php echo htmlspecialchars($error); ?></p>
                </div>
            <?php endif; ?>
        ...
        <?php if ($isExpired): ?>
            <p style="color: red; text-align: left; font-size: .7em;">Your verification code has expired. Please request a new one.</p>
            <form action="../server/resend_verification.php" method="POST">
                <button type="submit" class="resend-button" style="color: #2B3467; background: none; font-size: inherit; font-weight: 600;">Resend Verification Code</button>
            </form>
        <?php endif; ?>
    </div>
</body>
